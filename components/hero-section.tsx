    ...
    return (
                <div className="flex flex-col gap-20  lg:px-20 md:px-14 px-8 py-10 relative " >
                    <div className="flex flex-col items-center justify-center pt-20 md:gap-6 inter  " >
                        ...
                        <div className="md:px-56 opacity-80 text-center text-white lg:text-xl md:text-base text-xs font-medium leading-normal">
                        ...
                        <div className="flex bg-white lg:w-96 p-2 rounded-3xl " >
                            ...
                            <Button className='rounded-3xl  bg-gradient-to-r from-blue-500 to-blue-800 hover:text-white/75  text-white font-semibold md:text-base text-sm' size='default' >
                                Start for free
                            </Button>
                        </div>
                    </div>
